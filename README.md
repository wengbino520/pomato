...
| 📓 **日记记录** | 独立日记 Tab，支持按日期写作、情绪/精力/压力记录、富文本工具栏、表格插入与增删行列/合并拆分/列宽调整、图片粘贴/拖拽、自动保存切换日期草稿 |
| 📚 **日记历史** | 左侧日期列表 + 右侧预览，支持搜索、附件列表和双击打开本地附件，快速查看某天是否写过、情绪状态、字数和最后更新时间 |
...
- 支持 **加粗 / 列表 / 引用 / 表格 / 图片** 等轻量富文本操作
- 表格支持 **增删行列**、**合并 / 拆分单元格** 与 **列宽调整**
- 支持直接 **粘贴截图** 或 **拖拽本地图片** 到编辑区
- 右侧显示 **今日速览**、**写作提示**、**今日状态**
