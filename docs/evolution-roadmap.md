...
| ~~智能标签推荐~~ | ~~基于频率推荐~~ → 简化为上一轮标签预选 | 低 |
| 快捷键增强 | `Ctrl+1~9` 快速选标签、`Ctrl+D` 跳过、`Ctrl+S` 提交 | 低 |
| 休息结束轻柔提醒 | `BreakReminderWindow` 半透明淡入窗替代系统 toast | 中 |

**预估**: 3-4 小时 | **实际**: 2 小时 | **测试**: 17 新用例
...
| M2 | v2.2 | 可视化看板 + 弹窗优化 | 2026-06-26 | ✅ 提前完成 (6/14) |
